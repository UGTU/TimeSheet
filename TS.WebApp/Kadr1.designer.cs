...
namespace TimeSheetMvc4WebApplication
{
    ...
    partial void OnIdTimeSheetRecordChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TimeSheetView_TimeSheetRecord", Storage="_TimeSheetView", ThisKey="idTimeSheet", OtherKey="id", IsForeignKey=true)]
		public TimeSheetView TimeSheetView
		{
			get
			{
