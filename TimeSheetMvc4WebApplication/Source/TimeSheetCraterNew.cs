...
{
    public class TimeSheetCraterNew
    {
        ...
        public TimeSheetCraterNew()
        {
        }

        public TimeSheetCraterNew(int idDepartment, DateTime dateBeginPeriod, DateTime dateEndPeriod,DtoApproverDepartment dtoApproverDepartment, KadrDataContext db)
        {
            _db = db;
        ...
        public TimeSheetCraterNew(int idTimeSheet, KadrDataContext db)
        {
            _db = db;
