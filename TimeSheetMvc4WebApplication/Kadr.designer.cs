...
namespace TimeSheetMvc4WebApplication
{
    ...
    partial void DeleteTimeSheetRecord(TimeSheetRecord instance);
		...
		public KadrDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["UgtuDbKadrConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnIdTimeSheetRecordChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IdTimeSheetRecord", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
